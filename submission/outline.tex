...
\begin{figure}
\centering
\includegraphics[width=5.20833in,height=\textheight,keepaspectratio]{images/figure_8.png}
...
\begin{figure}
\centering
\includegraphics[width=6.25in,height=\textheight,keepaspectratio]{../visuals/fig3_3_trends_seasons_0120c.png}
\caption{Interannual and seasonal trends of \(PM_{10}\) and \(PM_{2.5}\)
variations}
\end{figure}
