...
[AND] surface ... [AND] anthropogenic, livestock These findings
highlight the significant contribution of the Gobi Desert to global dust
aerosols and the complex nature of its aerosol composition.
...
### The trends in concentrations of PMS and fine-coarse fractional changes at the sites

#### Inter-annual and intra-seasonal variations of of WS, PM10, PM2.5 and r-Ratio 

To demonstrate the time-series trends in Interannual variations At UB,
...
![Interannual and seasonal trends of \$PM\_{10}\$ and \$PM\_{2.5}\$
variations](images/figure_8.png){width="700"} ![Interannual and seasonal
trends of \$PM\_{10}\$ and \$PM\_{2.5}\$
variations](images/figure_9.png){width="300"}

#### r-ratio in spring when dust
...
XXXX Tsatsral), unrealistic PM2.5 values exceed PM10 (pm2.5 \> pm10
\*1.1) and detected signals that invariate with an extended period
caused by electricity shortage and equipment malfunctions for all sites.
Further, we handled data each stations separately to remove suspective
data, carefully. For example, In Sainshand station, … was … Prior to
data quality improvement, there were missing data with percentages
ranged from 10.3% to 23.6%, attributed to equipment malfunctions or
adverse weather conditions. Ulaanbaatar demonstrated the highest data
completeness for both PM2.5 (88.6%) and PM10 (89.7%), whereas
Dalanzadgad recorded the lowest (PM2.5: 76.4%; PM10: 81.5%)(Table 1).
After data quality improvement, missing data percentages has increased
by XXXXXX. [Due to electricity shortage and equipment malfunctions
contributed to the bad data, and missing data....]
...
percents by… from … to … Additionally, meteorological parameters such as
wind speed, direction, and visibility are integrated into the analysis
to elucidate their impact on PM levels.
...
```{r, lab2, results="asis", fig.align="center", out.width="4.5in", fig.pos= 'H'}
dt("lab2", "This is table 2")
include_graphics("images/tbl2_seasonal_to_annual.png")
```
...
```{r, lab3, results="asis", fig.align="center", out.width="8in", fig.pos= 'H'}
dt("lab3", "This is table 3: Seasonal and Annual
trends")
include_graphics("images/tbl3_pre_post_2014.png")
```
...
```{r, lab1, results="asis", fig.align="center", out.width="4.5in"}
dt("lab1", "This is table 1")
include_graphics("images/table_1.png")
```
...
variations](images/figure_8_supplement.png){width="600"}

Figure 8 illustrates the trend analysis of PM10 and PM2.5 concentrations
across study sites from 2008 to 2020. The time series demonstrates
seasonal patterns and trends, with p-values of trend changes,
seasonally: winter (Q1), spring (Q2), summer and autumn (Q3).

![Interannual and seasonal trends of $PM_{10}$ and $PM_{2.5}$
variations](images/figure_9_supplement.png){width="600"}
